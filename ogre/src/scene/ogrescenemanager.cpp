...
namespace Engine
{
	namespace Scene
	{
		...
		//---------------------------------------------------------------------------
		void OgreSceneManager::createCamera()
		{
			// Create the camera
		...
		const std::vector<Ogre::SceneNode*>& OgreSceneManager::terrainEntities() const
		{
		...
		Ogre::SceneNode* OgreSceneManager::camera() const
		{
			return mCameraNode;
		}

		Ogre::SceneManager* OgreSceneManager::getSceneManager() const
		{
			return mSceneMgr;
		}
		...
		Ogre::Image OgreSceneManager::getScreenshot() const
		{
			Ogre::Image image;
		...
		const Ogre::SceneNode* OgreSceneManager::terrain() const
		{
			return mTerrain;
		}

		Ogre::Ray OgreSceneManager::mousePointToRay(const Ogre::Vector2& mousePos) const
		{
		...
		Ogre::Viewport* OgreSceneManager::getViewport() const
		{
			return mVp;
		}

		Ogre::RenderTarget* OgreSceneManager::getRenderTarget() const
		{
