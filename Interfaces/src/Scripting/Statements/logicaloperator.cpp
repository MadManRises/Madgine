...
LogicalOperator::LogicalOperator(int line, const std::string &op, std::unique_ptr<const Statement> &&first,
	...
	Statement(line)
{
    if (op == "&&") {
        ...
        throw ScriptingException(Exceptions::unknownLogicalOperator(op));
    }
}
