...
set(CMAKE_CXX_FLAGS_INIT "-s USE_PTHREADS=0 -s -s ALLOW_MEMORY_GROWTH=1")
set(CMAKE_EXE_LINKER_FLAGS_INIT "--emrun -s DEMANGLE_SUPPORT=1 -s USE_WEBGL2=1 -s ERROR_ON_UNDEFINED_SYMBOLS=1 -s ALLOW_MEMORY_GROWTH=1")
set(CMAKE_SHARED_LINKER_FLAGS_INIT "--emrun -s DEMANGLE_SUPPORT=1 -s USE_WEBGL2=1 -s SIDE_MODULE=1 -s EXPORT_ALL=1 -s ERROR_ON_UNDEFINED_SYMBOLS=1")
...
set(CMAKE_CXX_FLAGS_DEBUG_INIT "-gsource-map -s DISABLE_EXCEPTION_CATCHING=0")
set(CMAKE_EXE_LINKER_FLAGS_DEBUG_INIT "-gsource-map --source-map-base http://localhost:9090/")
set(CMAKE_SHARED_LINKER_FLAGS_DEBUG_INIT "-gsource-map --source-map-base http://localhost:9090/")