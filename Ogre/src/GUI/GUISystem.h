...
namespace Engine {
	namespace GUI {
		...
		class OGREMADGINE_EXPORT GUISystem : public Ogre::Singleton<GUISystem>, public MadgineObject<GUISystem>, public Ogre::GeneralAllocatedObject, public Ogre::WindowEventListener
		{
		public:
			GUISystem();
			virtual ~GUISystem();
