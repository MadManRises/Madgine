...
NATIVE_BEHAVIOR(Widget_PointerEnter, Engine::Widgets::widget_pointer_enter_sender)
NATIVE_BEHAVIOR(Widget_PointerLeave, Engine::Widgets::widget_pointer_leave_sender)