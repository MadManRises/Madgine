...
namespace NodeGraph {
    ...
    struct MADGINE_NODEGRAPH_EXPORT FunctionNode : Node<FunctionNode> {
        ...
        virtual void interpretRead(NodeInterpreterState &interpreter, ValueType &retVal, std::unique_ptr<NodeInterpreterData> &data, uint32_t providerIndex, uint32_t group) const override;
