...
namespace Render {
    ...
    struct MADGINE_DIRECTX12_EXPORT DirectX12ProgramLoader : Resources::VirtualResourceLoaderImpl<DirectX12ProgramLoader, DirectX12Program, ProgramLoader> {
        ...
        void unloadImpl(DirectX12Program &program);
        Threading::Task<bool> create(Program &program, std::string name, std::vector<size_t> bufferSizes = {}, size_t instanceDataSize = 0) override;
