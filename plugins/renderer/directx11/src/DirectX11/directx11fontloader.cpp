...
namespace Render {
    ...
    DirectX11FontLoader::DirectX11FontLoader()
        : VirtualResourceLoaderImpl({ ".ttf" })
    {
    }

    bool DirectX11FontLoader::loadImpl(DirectX11FontData &font, ResourceType *res)
    {
    ...
    void DirectX11FontLoader::unloadImpl(DirectX11FontData &font, ResourceType *res)
    {
        font.mTexture.reset();
    }
...
VIRTUALUNIQUECOMPONENT(Engine::Render::DirectX11FontLoader);

METATABLE_BEGIN(Engine::Render::DirectX11FontLoader)
MEMBER(mResources)
METATABLE_END(Engine::Render::DirectX11FontLoader)

METATABLE_BEGIN_BASE(Engine::Render::DirectX11FontLoader::ResourceType, Engine::Render::FontLoader::ResourceType)
METATABLE_END(Engine::Render::DirectX11FontLoader::ResourceType)

RegisterType(Engine::Render::DirectX11FontLoader);
