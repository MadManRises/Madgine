...
UNIQUECOMPONENT(Engine::Render::DirectX11TextureLoader);
...
namespace Render {
    ...
    bool DirectX11TextureLoader::create(Texture &tex, TextureType type, TextureFormat format /*, D3D11_BIND_FLAG bind*/)
    {
