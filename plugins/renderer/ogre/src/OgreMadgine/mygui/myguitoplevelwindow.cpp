...
namespace Engine
{
	namespace GUI
	{
		...
		bool MyGUITopLevelWindow::handleKeyPress(const Input::KeyEventArgs& arg)
		{
		...
		bool MyGUITopLevelWindow::handleKeyRelease(const Input::KeyEventArgs& arg)
		{
		...
		bool MyGUITopLevelWindow::handleMousePress(const Input::MouseEventArgs& arg)
		{
		...
		bool MyGUITopLevelWindow::handleMouseRelease(const Input::MouseEventArgs& arg)
		{
		...
		bool MyGUITopLevelWindow::handleMouseMove(const Input::MouseEventArgs& arg)
		{
