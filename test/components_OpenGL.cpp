...
#endif
#if defined(BUILD_OpenGL) && defined(BUILD_Modules)
...
#endif
#if defined(BUILD_NodeGraph) && defined(BUILD_Modules)
#include "Madgine/nodegraph/nodegraphloader.h"
#endif
#if defined(BUILD_AnimationLoader) && defined(BUILD_Modules)
#include "animationloader.h"
#endif
#if defined(BUILD_MeshLoader) && defined(BUILD_Modules)
#include "meshloader.h"
#endif
#if defined(BUILD_Modules) && defined(BUILD_FontLoader)
