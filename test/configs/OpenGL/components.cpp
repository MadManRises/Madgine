...
#endif
#if (defined(BUILD_Root) && defined(BUILD_Debugger))
...
#endif
#if (defined(BUILD_Tools) && defined(BUILD_DebuggerTools))
...
#endif
#if (defined(BUILD_Tools) && defined(BUILD_MadgineLauncherTools))
#include "Madgine_Tools/launcher/launchertool.h"
#endif
#if (defined(BUILD_Tools) && defined(BUILD_Python3Tools))
