...
std::tuple<Ogre::SceneNode *, std::string, Ogre::Entity*> OgreSceneManager::createEntityData(const std::string & name, const std::string & meshName, const std::string & behaviour)
{
	...
	return std::make_tuple(node, behaviour, mesh);
