...
namespace Engine {
	...
	//---------------------------------------------------------------------------
	void OgreSceneRenderer::createCamera()
	{
		// Create the camera
	...
	bool OgreSceneRenderer::rayToTerrainPoint(const Ogre::Ray& ray,
		Ogre::Vector3& result, Ogre::uint32 mask)
	{
		if (mTerrainGroup && mask & Scene::Entity::Masks::TERRAIN_MASK)
		{
			...
			if (mask == Scene::Entity::Masks::TERRAIN_MASK)
				return false;
		}
...
Ogre::TerrainGroup* OgreSceneRenderer::terrainGroup() const
{
...
void OgreSceneRenderer::setGameTextureSize(const Ogre::Vector2& size)
{
...
Resources::OgreTexturePtr& OgreSceneRenderer::getGameTexture()
{
	return mGameTexture;
}

Ogre::Viewport* OgreSceneRenderer::getViewport() const
{
	return mVp;
}

Ogre::RenderTarget* OgreSceneRenderer::getRenderTarget() const
{
