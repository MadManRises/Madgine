...
namespace Serialize {
    ...
    struct MODULES_EXPORT SerializableDataConstPtr {
    private:
        template <typename T>
    ...
    struct MODULES_EXPORT SerializableDataPtr : SerializableDataConstPtr {
    private:
        template <typename T>
    ...
    struct MODULES_EXPORT SerializableUnitConstPtr : SerializableDataConstPtr {
    private:
        template <typename T>
