...
namespace Engine{
	...
	INTERFACES_EXPORT void exportStaticComponentHeader(const Filesystem::Path &outFile, std::vector<const TypeInfo*> skip = {});
		
	INTERFACES_EXPORT std::map<std::string, ComponentRegistryBase *> &registryRegistry();

	struct INTERFACES_EXPORT ComponentRegistryBase {
